...
describe "Authentication" do
  ...
  describe "signin" do
    before { visit signin_path }
      ...
      end #end "with valid information" description

   
   end #end "signin" description#
    ...
    describe "for non-signed-in users" do
      ...
      describe "in the Users controller" do
        ...
        ##describe "visiting the edit page" do
         ## before { visit edit_user_path(user) }
         ## end  #was I supposed to comment ##lines out?  did so for 9.17, implementing
         #visiting protected page stuff below

        describe "submitting to the update action" do
          before { put user_path(user) }
          # before {click_buttion "Save changes" } #  #why doesn't click_button work? b/c no page
          # specified when button clicks yet?
...
describe "should not be able to delete other posts" do
 let(:user) { FactoryGirl.create(:user) }
 let(:user2) {FactoryGirl.create(:user)}
         ...
         it {should have_content ('Dolor')}
      end #delete other posts 
